...
export const CATEGORIES = [
  ...
  { key: '태국', ja: 'タイ料理', icon: '🥥', color: '#8E44AD' },
];
...
export const UI = {
  ko: {
    ...
    fridgeClear: '선택 초기화',
    subsEntry: '🔁 재료 대체 가이드', subsTitle: '재료 대체 가이드',
    subsHint: '일본 슈퍼에서 구하기 어려운 한국 재료의 대체품과 구입처예요.',
    subsSub: '대체', subsBuy: '구입처', recipeSubs: '🔁 한국 재료 대체 팁',
  ...
  ja: {
    ...
    fridgeClear: '選択をリセット',
    subsEntry: '🔁 食材の代替ガイド', subsTitle: '食材の代替ガイド',
    subsHint: '日本のスーパーで手に入りにくい韓国食材の代替品と購入先です。',
    subsSub: '代替', subsBuy: '購入先', recipeSubs: '🔁 韓国食材の代替ヒント',
